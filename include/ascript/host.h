...
class host {
	...
	//!Must return the symbol defined in the host or throw a parser_error if the
	...
	//!Must add the given value to the symbol table or throw parser error if the
	//!symbol is already defined.
	virtual void                host_add(const std::string&, variable)=0;

	//!Must set the given value to the symbol table or throw parser error if the
